...
-- SAMLPLE_T의 전체 데이터 조회하기
SELECT *
FROM SAMPLE_T;

-- SAMPLE_T의 전체 데이터와 점수 합계
...
/*
    ...
    2. NVL2(EXPR, VALUE IF EXPR IS NOT NULL, VALUE IF EXPR IS NOT NULL)
*/
...
, NVL2(COMMISSION_PCT, SALARY * (1 + COMMISSION_PCT), SALARY) AS PAY
FROM employees;
