/*
    1. DATE 형식의 날짜/시간 연산
        ...
        2) 단위 처리
            ...
            (4) 1/24/60/60 : 1초
*/
SELECT TO_CHAR(SYSDATE, 'YY/MM/DD HH24:MI:SS') --현 시간
     , TO_CHAR(SYSDATE + 1, 'YY/MM/DD HH24:MI:SS') --1일후
...
/*
    2. TIMESTAMP 형식의 날짜/시간 연산
        ...
        2) YEAR, MONTH, DAY, HOUR, SECOND 단위를 사용한다.
*/
SELECT SYSTIMESTAMP + INTERVAL '1' YEAR   --1년후
, SYSTIMESTAMP + INTERVAL '1' MONTH   --1달후
FROM DUAL;
