-- 1. 암호화하기 (해시 알고리즘)ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
...
-- 2. 순위 구하기 (동점자의 경우 같은 순위를 가짐)ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
...
-- 3. 행 번호 구하기 (동점자 처리 방식이 없음)ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
SELECT EMP_NO, NAME, SALARY
...
-- 4. 분기 처리하기ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
...
SELECT EMP_NO
    ...
    , CASE
        ...
        WHEN DEPART = 1 THEN '인사부'
        WHEN DEPART = 1 THEN '총무부'
        WHEN DEPART = 1 THEN '기획부'
        ELSE 'UNKNOWN'
        END AS 부서명
FROM EMPLOYEE_T;
